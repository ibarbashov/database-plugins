...
public class PostgresPostActionTestRun extends PostgresPluginTestBase {
  ...
  public void testAction() throws Exception {
    ...
    ETLStage action = new ETLStage("action", new ETLPlugin(
      ...
      ImmutableMap.<String, String>builder()
        .putAll(BASE_PROPS)
        .put(QueryConfig.QUERY,
             "delete from \"postActionTest\" where \"day\" = '${logicalStartTime(yyyy-MM-dd,0m,UTC)}'")
