...
public class MysqlPluginTestBase extends DatabasePluginTestBase {
  ...
  protected static Map<String, String> sinkProps;
  ...
  public static void setupTest() throws Exception {
    ...
    sinkProps = ImmutableMap.<String, String>builder()
      .putAll(BASE_PROPS)
    ...
    PluginClass hypersql = new PluginClass("jdbc", JDBC_DRIVER_NAME, "mysql driver class", Driver.class.getName(),
    ...
    addPluginArtifact(NamespaceId.DEFAULT.artifact("mysql-jdbc-connector", "1.0.0"),
                      DATAPIPELINE_ARTIFACT_ID,
                      Sets.newHashSet(hypersql), Driver.class);


    String mysqlDir = temporaryFolder.newFolder(JDBC_DRIVER_NAME).getAbsolutePath();
    TimeZone.setDefault(TimeZone.getTimeZone("UTC"));

    connectionUrl = "jdbc:mysql://" + BASE_PROPS.get("host") + ":" + BASE_PROPS.get("port") + "/" + BASE_PROPS.get("database");
  ...
  public static Connection createConnection() {
    try {
      ...
      return DriverManager.getConnection(connectionUrl, "root", "mysql");
    } catch (Exception e) {
