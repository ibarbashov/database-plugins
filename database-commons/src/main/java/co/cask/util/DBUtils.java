...
public final class DBUtils {
  ...
  public static void validateJDBCPluginPipeline(PipelineConfigurer pipelineConfigurer,
                                                ConnectionConfig config, String jdbcPluginId, String jdbcDriverName) {
    ...
    Preconditions.checkArgument(
      ...
      jdbcDriverName,
      jdbcDriverName, ConnectionConfig.JDBC_PLUGIN_TYPE);
  }
  ...
  public static String createConnectionString(ConnectionConfig config, String jdbcDriverName) {
    return createConnectionString(config.host, config.port, config.database, jdbcDriverName);
  }

  public static String createConnectionString(String host, int port, String database, String jdbcDriverName) {
    return ConnectionConfig.JDBC_PLUGIN_TYPE + ":" + jdbcDriverName + "://"
      + host + ":" + port + "/" + database;
  }
