...
Use Case
--------
The source is used whenever you need to read from a Mysql. For example, you may want
...
**Max Rows** The maximum number of rows to return (0, the default means return all rows)
